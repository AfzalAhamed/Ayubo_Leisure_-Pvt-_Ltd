...
{
    public partial class CalculateLongHire : Form
    {
        public CalculateLongHire()
        {
            InitializeComponent();
        }
        ...
        private void CalculateLongHire_Load(object sender, EventArgs e)
        {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != string.Empty || textBox2.Text != string.Empty || textBox3.Text != string.Empty || textBox4.Text != string.Empty)
            {
                ...
                h = hire.LongHireCalculation(int.Parse(textBox1.Text), textBox2.Text, dateTimePicker1.Value, dateTimePicker2.Value, int.Parse(textBox3.Text), int.Parse(textBox4.Text));
                if (h[0] == -1)
                {
